    ...
    const sampleEvents: TimelineEvent[] = [
      {
        ...
        description: 'Joint Entrance Examination (Main) - First attempt for admission to NITs, IIITs and other CFTIs.',
        date: '2025-01-24',
        endDate: '2025-01-31',
        type: 'exam',
        status: 'upcoming',
      ...
      },
      {
        ...
        description: 'National Eligibility cum Entrance Test registration for medical courses.',
        date: '2025-02-15',
        endDate: '2025-03-15',
        type: 'exam',
        status: 'upcoming',
      ...
      },
      {
        ...
        description: 'Final preparation phase for Class 12 board examinations.',
        date: '2025-01-01',
        endDate: '2025-02-28',
        type: 'preparation',
        status: 'active',
      ...
      },
      {
        ...
        description: 'Results for JEE Main 2025 Session 1 will be declared.',
        date: '2025-02-12',
        type: 'deadline',
        status: 'upcoming',
        priority: 'medium'
